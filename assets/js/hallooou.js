...
$(function() {
        if (geoplugin_countryCode() == "US") {
            window.location.href = "http://YourAffiliateLink.com"    <!-- This directs to United States -->
        } else if (geoplugin_countryCode() == "GB") {
            window.location.href = "http://YourAffiliateLink.com"    <!-- This directs to United Kingdom -->
        } else if (geoplugin_countryCode() == "RU") {
            window.location.href = "http://YourAffiliateLink.com"    <!-- This directs to Russia -->
        } else {
